'use strict';define("metaphorjs-validator",["metaphorjs-observable","metaphorjs-ajax","metaphorjs-select","metaphorjs-input"],function(C,L,D,H){function x(d){return"object"==typeof d&&3===I(d)&&!d.nodeType&&d.constructor===Object}function E(d){return!0===d||!1===d}function u(d){return"string"==typeof d||d===""+d}function M(d,e,g){d.attachEvent?d.attachEvent("on"+e,g):d.addEventListener(e,g,!1)}function N(d,e,g){d.detachEvent?d.detachEvent("on"+e,g):d.removeEventListener(e,g,!1)}function s(d,e){var g;
if(g=e)g=!(e&&B("(?:^|\\s)"+e+"(?!\\S)").test(d.className));g&&(d.className+=" "+e)}function q(d,e){e&&(d.className=d.className.replace(B("(?:^|\\s)"+e+"(?!\\S)"),""))}function F(d,e,g){var f,l=d.childNodes;if(!1!==e.call(g,d))for(d=-1,f=l.length>>>0;++d!==f;F(l[d],e,g));}function v(){return!1}function y(){return!0}function z(d){return"function"==typeof d}var G=H.getValue,O=Array.prototype.slice,P=Object.prototype.toString,I=function(){var d={"[object String]":0,"[object Number]":1,"[object Boolean]":2,
"[object Object]":3,"[object Function]":4,"[object Array]":5,"[object RegExp]":9,"[object Date]":10};return function(e){if(!e){if(null===e)return 6;if(void 0===e)return 7}var g=d[P.call(e)];return void 0===g?-1:1==g&&isNaN(e)?8:g}}(),k=function(){return function e(){var g=!1,f=!1,l=O.call(arguments),m=l.shift(),k,p,r;E(l[l.length-1])&&(g=l.pop());E(l[l.length-1])&&(f=g,g=l.pop());for(;l.length;)if(k=l.shift())for(p in k)if(k.hasOwnProperty(p)&&void 0!==(r=k[p]))if(f)if(m[p]&&x(m[p])&&x(r))e(m[p],
r,g,f);else{if(!0===g||void 0==m[p])x(r)?(m[p]={},e(m[p],r,g,!0)):m[p]=r}else if(!0===g||void 0==m[p])m[p]=r;return m}}(),A=function(){return String.prototype.trim?function(d){return u(d)?d.trim():d}:function(d){return u(d)?d.replace(/^\s\s*/,"").replace(/\s\s*$/,""):d}}(),w=Function.prototype.bind?function(d,e){return d.bind(e)}:function(d,e){return function(){return d.apply(e,arguments)}},B=function(){var d={};return function(e){return d[e]||(d[e]=new RegExp(e))}}(),t=function(d){if(d instanceof
t)return d;if(!(this instanceof t))return new t(d);for(var e in d)if(!this[e])try{this[e]=d[e]}catch(g){}this.originalEvent=d;this.type=d.type;!this.target&&d.srcElement&&(this.target=d.srcElement);var f,l=d.button;void 0===this.pageX&&null!==d.clientX&&(f=this.target?this.target.ownerDocument||document:document,e=f.documentElement,f=f.body,this.pageX=d.clientX+(e&&e.scrollLeft||f&&f.scrollLeft||0)-(e&&e.clientLeft||f&&f.clientLeft||0),this.pageY=d.clientY+(e&&e.scrollTop||f&&f.scrollTop||0)-(e&&
e.clientTop||f&&f.clientTop||0));this.which||void 0===l||(this.which=l&1?1:l&2?3:l&4?2:0);this.isDefaultPrevented=d.defaultPrevented||void 0===d.defaultPrevented&&!1===d.returnValue?y:v;this.timeStamp=d&&d.timeStamp||(new Date).getTime()};k(t.prototype,{isDefaultPrevented:v,isPropagationStopped:v,isImmediatePropagationStopped:v,preventDefault:function(){var d=this.originalEvent;this.isDefaultPrevented=y;d.returnValue=!1;d&&d.preventDefault&&d.preventDefault()},stopPropagation:function(){var d=this.originalEvent;
this.isPropagationStopped=y;d&&d.stopPropagation&&d.stopPropagation()},stopImmediatePropagation:function(){var d=this.originalEvent;this.isImmediatePropagationStopped=y;d&&d.stopImmediatePropagation&&d.stopImmediatePropagation();this.stopPropagation()}},!0,!1);var K=function(){var d=0,e={},g=function(a,b){var c=0;switch(b.nodeName.toLowerCase()){case "select":return F(b,function(a){a.selected&&c++}),c;case "input":if(/radio|checkbox/i.test(b.type))return F(b.form,function(a){a.type==b.type&&a.name==
b.name&&a.checked&&c++}),c}return a.length},f=function(a,b){if(!b)return void 0==a||""===a;switch(b.nodeName.toLowerCase()){case "select":var c=G(b);return!c||0==c.length;case "input":if(/radio|checkbox/i.test(b.type))return 0==g(a,b)}return 0==A(a).length},l=function(a,b){if(z(b))return a;if("object"!=typeof b||5!==I(b))b=[b];var c,h=b.length;for(c=-1;++c<h;a=a.replace(new RegExp("\\{"+c+"\\}","g"),b[c]));return a},m={};k(m,{required:function(a,b,c){return!1===c?!0:!f(a,b)},regexp:function(a,b,c){c=
c instanceof RegExp?c:new RegExp(c);return f(a,b)||c.test(a)},notregexp:function(a,b,c){c=c instanceof RegExp?c:new RegExp(c);return f(a,b)||!c.test(a)},minlength:function(a,b,c){return f(a,b)||(b?g(A(a),b)>=c:a.toString().length>=c)},maxlength:function(a,b,c){return f(a,b)||(b?g(A(a),b)<=c:a.toString().length<=c)},rangelength:function(a,b,c){var h=b?g(A(a),b):a.toString().length;return f(a,b)||h>=c[0]&&h<=c[1]},min:function(a,b,c){return f(a,b)||parseInt(a,10)>=c},max:function(a,b,c){return f(a,
...
c%10},accept:function(a,b,c){c=u(c)?c.replace(/,/g,"|"):"png|jpe?g|gif";return f(a,b)||a.match(new RegExp(".("+c+")$","i"))},equalto:function(a,b,c,h){c=(b=h.getValidator().getField(c))?b.getElem():c;return a==G(c)},notequalto:function(a,b,c,h){c=(b=h.getValidator().getField(c))?b.getElem():c;return a!=G(c)},zxcvbn:function(a,b,c){return zxcvbn(a).score>=parseInt(c)}});var J={required:"This field is required.",remote:"Please fix this field.",email:"Please enter a valid email address.",url:"Please enter a valid URL.",
date:"Please enter a valid date.",dateISO:"Please enter a valid date (ISO).",number:"Please enter a valid number.",digits:"Please enter only digits.",creditcard:"Please enter a valid credit card number.",equalTo:"Please enter the same value again.",accept:"Please enter a value with a valid extension.",maxlength:"Please enter no more than {0} characters.",minlength:"Please enter at least {0} characters.",rangelength:"Please enter a value between {0} and {1} characters long.",range:"Please enter a value between {0} and {1}.",
max:"Please enter a value less than or equal to {0}.",min:"Please enter a value greater than or equal to {0}."},p={allowSubmit:!0,alwaysCheck:!1,alwaysDisplayState:!1,data:null,ignore:null,disabled:!1,cls:{valid:"",error:"",ajax:""},errorBox:{cls:"",fn:null,tag:"",position:"after",elem:null,enabled:!0},callback:{scope:null,destroy:null,statechange:null,errorchange:null,submit:null,check:null,beforeAjax:null,afterAjax:null,displaystate:null},rules:{},messages:{}},r=function(a){if(!a)return{};var b=
function(b,h,d){var e=a[b],f=!1;if(void 0!==e){switch(d){case "string":f=u(e);break;case "function":f=z(e);break;case "boolean":f=E(e)}f&&(a[b]={},a[b][h]=e)}};b("errorBox","enabled","boolean");b("errorBox","tag","string");b("errorBox","fn","function");return a},v=function(a,b,c){b=b||{};var h,d;this._observable=new C;k(this,this._observable.getApi());this.cfg=h=k({},p,r(n.fieldDefaults),r(b),!0,!0);this.input=new H(a,this.onInputChange,this,this.onInputSubmit);this.elem=a;this.vldr=c;this.callbackScope=
d=h.callback.scope;this.enabled=!a.disabled;this.id=a.getAttribute("name")||a.getAttribute("id");this.data=b.data;this.rules={};h.messages=k({},J,n.messages,h.messages,!0,!0);b=c.getVldId();a.setAttribute("data-validator",b);this.input.radio&&this.initRadio();for(var e in h.callback)if(h.callback[e])this.on(e,h.callback[e],d);h.rules&&this.setRules(h.rules,!1);this.readRules();this.prev=this.input.getValue();h.disabled&&this.disable()};k(v.prototype,{vldr:null,elem:null,rules:null,cfg:null,callbackScope:null,
...
(this.checkTmt=setTimeout(w(this.checkTimeout,this),100)),!0===this.valid;this.checking=!0;if(!(!0===a||b.equalTo||b.notEqualTo||this.dirty||null===this.valid||c.alwaysCheck))return this.pending||this.doDisplayState(),this.checking=!1,!0===this.valid;var d=!0,e=!1,f=this.getValue(),g,k;for(k in b)if("remote"==k){if(this.dirty||c.alwaysCheck||null===this.valid||!0===a)if(f||b[k].checkEmpty)e=!0}else if(!0!==(g=(z(b[k])?b[k]:m[k]).call(this.callbackScope,f,h,b[k],this))){d=!1;this.setError(l(g||c.messages[k]||
"",b[k]),k);break}e=e&&d;d&&this.setError(null);e?this.ajaxCheck():(this.setValidState(d),this.doDisplayState());this.checking=this.dirty=!1;this.trigger("check",this,this.valid);return!0===this.valid&&!e},doDisplayState:function(){var a=this.cfg,b=this.isValid(),c=a.cls.error,d=a.cls.valid,e=this.elem;this.displayState||a.alwaysDisplayState||(b=null);null===this.valid&&(b=null);c&&(!1===b?s(e,c):q(e,c));d&&(!0===b?s(e,d):q(e,d));c=this.getErrorBox();d=this.error;c&&(!1===b&&d&&(c.innerHTML=state.error),
...
this.check(!1),this.prev=this.input.getValue())},onInputSubmit:function(a){a=new t(a);if(!(a.isDefaultPrevented&&a.isDefaultPrevented()||!1!==this.trigger("submit",this,a)))return a.preventDefault(),!1},createErrorBox:function(){var a=this.cfg.errorBox,b=a.tag,c=a.cls,d=a.fn,e=a.position,a=a.elem;d?this.errorBox=d.call(this.callbackScope,this):a?this.errorBox=a:(this.errorBox=document.createElement(b),this.errorBox.className=c,b=(b=this.input.radio)?b[b-1]:this.elem,"appendParent"==e?b.parentNode.appendChild(this.errorBox):
"before"==e?b.parentNode.insertBefore(this.errorBox,b):b.parentNode.insertBefore(this.errorBox,b.nextSibling))},ajaxCheck:function(){var a=this.elem,b=this.rules.remote,c=this.getValue(),d=this.cfg,b=k({},u(b)?{url:b}:b,!0);b.data=b.data||{};b.data[b.paramName||a.getAttribute("name")||a.getAttribute("id")]=c;b.handler||(b.dataType="text");b.cache=!1;d.cls.ajax&&s(a,d.cls.ajax);this.trigger("beforeAjax",this,b);this.pending=L(b);this.pending.done(w(this.onAjaxSuccess,this));this.pending.fail(w(this.onAjaxError,
this))},onAjaxSuccess:function(a){var b=this.rules,c=this.cfg;this.pending=null;var d=!0;b.remote.handler?(a=b.remote.handler.call(this.callbackScope,this,a),!0!==a&&(this.setError(l(a||c.messages.remote||"",b.remote),"remote"),d=!1)):a?(this.setError(a,"remote"),d=!1):this.setError(null);c.cls.ajax&&q(this.elem,c.cls.ajax);this.setValidState(d);this.doDisplayState();this.trigger("afterAjax",this)},onAjaxError:function(a,b){var c=this.cfg;c.cls.ajax&&q(this.elem,c.cls.ajax);this.pending=null;"abort"!=
b&&"abort"!=a&&(this.setValidState(!1),this.doDisplayState(),this.trigger("afterAjax",this))}},!0,!1);var y={alwaysCheck:!1,alwaysDisplayState:!1,disabled:!1,value:null,elem:null,errorBox:null,errorField:null,data:null,cls:{valid:"",error:""},fields:[],rules:{},messages:{},callback:{scope:null,destroy:null,statechange:null,errorchange:null,displaystate:null}},x=function(a,b){a=a||{};var c,d;this._observable=new C;this._vldr=b;k(this,this._observable.getApi());this.cfg=c=k({},y,n.groupDefaults,a,!0,
!0);this.callbackScope=d=c.callback.scope;this.data=a.data;this.el=a.elem;this.fields={};this.rules={};c.messages=k({},J,n.messages,c.messages,!0,!0);var e;if(c.callback)for(e in c.callback)if(c.callback[e])this.on(e,c.callback[e],d);c.rules&&this.setRules(c.rules,!1);if(c.fields)for(e=0,d=a.fields.length;e<d;e++)this.add(b.getField(c.fields[e]));this.enabled=!c.disabled};k(x.prototype,{fields:null,rules:null,cfg:null,callbackScope:null,vldr:null,enabled:!1,invalid:null,valid:null,displayState:!1,
...
remove:function(a){var b=this.fields,c=a.getName();b[c]&&(delete b[c],this.setFieldEvents(a,"un"));return this},setValidState:function(a){this.valid!==a&&(this.valid=a,this.trigger("statechange",this,a))},countInvalid:function(){var a=this.fields;this.invalid=0;for(var b in a)this.invalid+=a[b].isValid()?0:1},onFieldStateChange:function(a,b){this.trigger("fieldstatechange",this,a,b);this.check()}},!0,!1);var B={form:null,all:{},fields:{},rules:{},cls:{valid:"",error:"",checking:""},groups:{},callback:{scope:null,
destroy:null,reset:null,beforesubmit:null,submit:null,statechange:null,check:null,displaystate:null,displaystatechange:null}},n=function(a,b,c){var h=a.nodeName.toLowerCase();this.vldId=++d;e[this.vldId]=this;a.setAttribute("data-validator",this.vldId);this.el=a;b&&!u(b)&&(c=b,b=null);this._observable=new C;this.cfg=a=k({},B,n.defaults,n[b],c,!0,!0);this.callbackScope=b=a.callback.scope;this.isForm="form"==h;this.isField=/input|select|textarea/.test(h);this.fields={};this.groups={};k(this,this._observable.getApi());
this._observable.createEvent("submit",!1);this._observable.createEvent("beforesubmit",!1);this.onRealSubmitClickDelegate=w(this.onRealSubmitClick,this);this.resetDelegate=w(this.reset,this);this.onSubmitClickDelegate=w(this.onSubmitClick,this);this.onFormSubmitDelegate=w(this.onFormSubmit,this);delete a.callback.scope;var f,g;for(g in a.callback)this.on(g,a.callback[g],b);this.initFields();h=this.fields;for(f in a.rules)h[f]&&h[f].setRules(a.rules[f],!1);a.rules=null;for(f in a.groups)this.addGroup(f,
a.groups[f]);this.initForm("bind");delete a.rules;delete a.fields;delete a.groups;this.enabled=!0};k(n.prototype,{vldId:null,el:null,cfg:null,enabled:!1,invalid:null,pending:0,grps:0,outside:!0,submitted:!1,displayState:!1,isForm:!1,isField:!1,submitButton:null,hidden:null,callbackScope:null,preventFormSubmit:!1,_observable:null,fields:null,groups:null,getVldId:function(){return this.vldId},getElem:function(){return this.el},getGroup:function(a){return this.groups[a]||null},getField:function(a){return this.fields[a]||
...
var d=a.getAttribute("name")||a.getAttribute("id"),e=this.cfg,c=this.fields;if(!d)return this;d=e.fields&&e.fields[d]?e.fields[d]:b||{};u(d)&&(d={rules:[d]});d=k({},e.all||{},d,!0,!0);if(d.ignore)return this;d.callback||(d.callback={scope:this.callbackScope});e=new v(a,d,this);d=e.getName();if(c[d])return this;c[d]=e;this.setFieldEvents(e,"on");this.displayState&&e.enableDisplayState();this.isEnabled()&&null!==this.invalid&&e.check();return this},addGroup:function(a,b){var c=this.groups;c[a]||(b.name=
...
b&&this.grps!==b)this.doDisplayState(),this.trigger("statechange",this,this.isValid())},doDisplayState:function(){var a=this.cfg,b=this.isValid(),c=a.cls.error,a=a.cls.valid,d=this.el;if(this.isField||!this.displayState)b=null;null===this.invalid&&(b=null);c&&(!1===b?s(d,c):q(d,c));a&&(!0===b?s(d,a):q(d,a));this.trigger("displaystate",this,b)},onBeforeAjax:function(){this.pending++;this.cfg.cls.ajax&&s(this.el,this.cfg.cls.ajax)},onAfterAjax:function(){var a=this.fields,b=this.cfg;this.pending=0;
for(var c in a)this.pending+=a[c].isPending()?1:0;this.doDisplayState();b.cls.ajax&&q(this.el,b.cls.ajax);this.submitted&&0==this.pending&&(this.submitted=!1,this.isValid()?this.submit():this.focusInvalid())},destroy:function(){var a=this.groups,b=this.fields,c;this.reset();this.trigger("destroy",this);delete e[this.vldId];for(c in a)a.hasOwnProperty(c)&&a[c]&&(this.setGroupEvents(a[c],"un"),a[c].destroy());for(c in b)b.hasOwnProperty(c)&&b[c]&&(this.setFieldEvents(b[c],"un"),b[c].destroy());this._observable.destroy();
this._observable=null;this.initForm("unbind");this.cfg=this.el=this.groups=this.fields=null}},!0,!1);n.defaults={};n.messages={};n.fieldDefaults={};n.groupDefaults={};n.addMethod=function(a,b,c){m[a]||(m[a]=b,c&&(n.messages[a]=c))};n.getValidator=function(a){a=a.getAttribute("data-validator");return e[a]||null};return n}();window.jQuery&&(jQuery.fn.metaphorjsValidator=function(d,e,g){var f="metaphorjsValidator",k;"string"==typeof d&&"destroy"!=d&&(k=d,d=e,e=g);e=e||"default";d=d||{};f+="-"+e;this.each(function(){var g=
$(this),q=g.data(f);if("destroy"==d)q&&(q.destroy(),g.data(f,null));else{if(q)throw Error("MetaphorJs validator is already instantiated for this html element");d.form=g;d.instanceName=e;g.data(f,new K(k,d))}})});return K});
