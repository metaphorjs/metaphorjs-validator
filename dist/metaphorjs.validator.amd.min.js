define("metaphorjs-validator",["metaphorjs-observable","metaphorjs-ajax","metaphorjs-select","metaphorjs-input"],function(C,L,D,H){var E=H.getValue,M=Array.prototype.slice,N=Object.prototype.toString,I=function(){var d={"[object String]":0,"[object Number]":1,"[object Boolean]":2,"[object Object]":3,"[object Function]":4,"[object Array]":5,"[object RegExp]":9,"[object Date]":10};return function(e){if(!e){if(null===e)return 6;if(void 0===e)return 7}var g=d[N.call(e)];return void 0===g?-1:1==g&&isNaN(e)?
8:g}}(),x=function(d){return"object"==typeof d&&3===I(d)&&!d.nodeType},F=function(d){return!0===d||!1===d},k=function(){return function e(){var g=!1,f=!1,l=M.call(arguments),m=l.shift(),k,p,r;F(l[l.length-1])&&(g=l.pop());F(l[l.length-1])&&(f=g,g=l.pop());for(;l.length;)if(k=l.shift())for(p in k)if(k.hasOwnProperty(p)&&void 0!==(r=k[p]))if(f)if(m[p]&&x(m[p])&&x(r))e(m[p],r,g,f);else{if(!0===g||void 0==m[p])x(r)?(m[p]={},e(m[p],r,g,!0)):m[p]=r}else if(!0===g||void 0==m[p])m[p]=r;return m}}(),u=function(d){return"string"==
typeof d||d===""+d},A=function(){return String.prototype.trim?function(d){return u(d)?d.trim():d}:function(d){return u(d)?d.replace(/^\s\s*/,"").replace(/\s\s*$/,""):d}}(),v=Function.prototype.bind?function(d,e){return d.bind(e)}:function(d,e){return function(){return d.apply(e,arguments)}},O=function(d,e,g){d.attachEvent?d.attachEvent("on"+e,g):d.addEventListener(e,g,!1)},P=function(d,e,g){d.detachEvent?d.detachEvent("on"+e,g):d.removeEventListener(e,g,!1)},B=function(){var d={};return function(e){return d[e]||
(d[e]=new RegExp(e))}}(),s=function(d,e){var g;if(g=e)g=!(e&&B("(?:^|\\s)"+e+"(?!\\S)").test(d.className));g&&(d.className+=" "+e)},q=function(d,e){e&&(d.className=d.className.replace(B("(?:^|\\s)"+e+"(?!\\S)"),""))},G=function(d,e,g){var f,l=d.childNodes;if(!1!==e.call(g,d))for(d=-1,f=l.length>>>0;++d!==f;G(l[d],e,g));},w=function(){return!1},y=function(){return!0},t=function(d){if(d instanceof t)return d;if(!(this instanceof t))return new t(d);for(var e in d)if(!this[e])try{this[e]=d[e]}catch(g){}this.originalEvent=
d;this.type=d.type;!this.target&&d.srcElement&&(this.target=d.srcElement);var f,l=d.button;void 0===this.pageX&&null!==d.clientX&&(f=this.target?this.target.ownerDocument||document:document,e=f.documentElement,f=f.body,this.pageX=d.clientX+(e&&e.scrollLeft||f&&f.scrollLeft||0)-(e&&e.clientLeft||f&&f.clientLeft||0),this.pageY=d.clientY+(e&&e.scrollTop||f&&f.scrollTop||0)-(e&&e.clientTop||f&&f.clientTop||0));this.which||void 0===l||(this.which=l&1?1:l&2?3:l&4?2:0);this.isDefaultPrevented=d.defaultPrevented||
void 0===d.defaultPrevented&&!1===d.returnValue?y:w;this.timeStamp=d&&d.timeStamp||(new Date).getTime()};t.prototype={isDefaultPrevented:w,isPropagationStopped:w,isImmediatePropagationStopped:w,preventDefault:function(){var d=this.originalEvent;this.isDefaultPrevented=y;d.returnValue=!1;d&&d.preventDefault&&d.preventDefault()},stopPropagation:function(){var d=this.originalEvent;this.isPropagationStopped=y;d&&d.stopPropagation&&d.stopPropagation()},stopImmediatePropagation:function(){var d=this.originalEvent;
this.isImmediatePropagationStopped=y;d&&d.stopImmediatePropagation&&d.stopImmediatePropagation();this.stopPropagation()}};var z=function(d){return"function"==typeof d},K=function(){var d=0,e={},g=function(a,b){var c=0;switch(b.nodeName.toLowerCase()){case "select":return G(b,function(a){a.selected&&c++}),c;case "input":if(/radio|checkbox/i.test(b.type))return G(b.form,function(a){a.type==b.type&&a.name==b.name&&a.checked&&c++}),c}return a.length},f=function(a,b){if(!b)return void 0==a||""===a;switch(b.nodeName.toLowerCase()){case "select":var c=
E(b);return!c||0==c.length;case "input":if(/radio|checkbox/i.test(b.type))return 0==g(a,b)}return 0==A(a).length},l=function(a,b){if(z(b))return a;if("object"!=typeof b||5!==I(b))b=[b];var c,h=b.length;for(c=-1;++c<h;a=a.replace(new RegExp("\\{"+c+"\\}","g"),b[c]));return a},m={};k(m,{required:function(a,b,c){return!1===c?!0:!f(a,b)},regexp:function(a,b,c){c=c instanceof RegExp?c:new RegExp(c);return f(a,b)||c.test(a)},notregexp:function(a,b,c){c=c instanceof RegExp?c:new RegExp(c);return f(a,b)||
...
c%10},accept:function(a,b,c){c=u(c)?c.replace(/,/g,"|"):"png|jpe?g|gif";return f(a,b)||a.match(new RegExp(".("+c+")$","i"))},equalto:function(a,b,c,h){c=(b=h.getValidator().getField(c))?b.getElem():c;return a==E(c)},notequalto:function(a,b,c,h){c=(b=h.getValidator().getField(c))?b.getElem():c;return a!=E(c)},zxcvbn:function(a,b,c){return zxcvbn(a).score>=parseInt(c)}});var J={required:"This field is required.",remote:"Please fix this field.",email:"Please enter a valid email address.",url:"Please enter a valid URL.",
...
function(b,h,d){var e=a[b],f=!1;if(void 0!==e){switch(d){case "string":f=u(e);break;case "function":f=z(e);break;case "boolean":f=F(e)}f&&(a[b]={},a[b][h]=e)}};b("errorBox","enabled","boolean");b("errorBox","tag","string");b("errorBox","fn","function");return a},w=function(a,b,c){b=b||{};var h,d;this._observable=new C;k(this,this._observable.getApi());this.cfg=h=k({},p,r(n.fieldDefaults),r(b),!0,!0);this.input=new H(a,this.onInputChange,this,this.onInputSubmit);this.elem=a;this.vldr=c;this.callbackScope=
d=h.callback.scope;this.enabled=!a.disabled;this.id=a.getAttribute("name")||a.getAttribute("id");this.data=b.data;this.rules={};h.messages=k({},J,n.messages,h.messages,!0,!0);b=c.getVldId();a.setAttribute("data-validator",b);this.input.radio&&this.initRadio();for(var e in h.callback)if(h.callback[e])this.on(e,h.callback[e],d);h.rules&&this.setRules(h.rules,!1);this.readRules();this.prev=this.input.getValue();h.disabled&&this.disable()};w.prototype={vldr:null,elem:null,rules:null,cfg:null,callbackScope:null,
...
c.cls.ajax);this.pending=null;"abort"!=b&&"abort"!=a&&(this.setValidState(!1),this.doDisplayState(),this.trigger("afterAjax",this))}};var y={alwaysCheck:!1,alwaysDisplayState:!1,disabled:!1,value:null,elem:null,errorBox:null,errorField:null,data:null,cls:{valid:"",error:""},fields:[],rules:{},messages:{},callback:{scope:null,destroy:null,statechange:null,errorchange:null,displaystate:null}},x=function(a,b){a=a||{};var c,d;this._observable=new C;this._vldr=b;k(this,this._observable.getApi());this.cfg=
c=k({},y,n.groupDefaults,a,!0,!0);this.callbackScope=d=c.callback.scope;this.data=a.data;this.el=a.elem;this.fields={};this.rules={};c.messages=k({},J,n.messages,c.messages,!0,!0);var e;if(c.callback)for(e in c.callback)if(c.callback[e])this.on(e,c.callback[e],d);c.rules&&this.setRules(c.rules,!1);if(c.fields)for(e=0,d=a.fields.length;e<d;e++)this.add(b.getField(c.fields[e]));this.enabled=!c.disabled};x.prototype={fields:null,rules:null,cfg:null,callbackScope:null,vldr:null,enabled:!1,invalid:null,
...
this.groups={};k(this,this._observable.getApi());this._observable.createEvent("submit",!1);this._observable.createEvent("beforesubmit",!1);this.onRealSubmitClickDelegate=v(this.onRealSubmitClick,this);this.resetDelegate=v(this.reset,this);this.onSubmitClickDelegate=v(this.onSubmitClick,this);this.onFormSubmitDelegate=v(this.onFormSubmit,this);delete a.callback.scope;var f,g;for(g in a.callback)this.on(g,a.callback[g],b);this.initFields();h=this.fields;for(f in a.rules)h[f]&&h[f].setRules(a.rules[f],
!1);a.rules=null;for(f in a.groups)this.addGroup(f,a.groups[f]);this.initForm("bind");delete a.rules;delete a.fields;delete a.groups;this.enabled=!0};n.prototype={vldId:null,el:null,cfg:null,enabled:!1,invalid:null,pending:0,grps:0,outside:!0,submitted:!1,displayState:!1,isForm:!1,isField:!1,submitButton:null,hidden:null,callbackScope:null,preventFormSubmit:!1,_observable:null,fields:null,groups:null,getVldId:function(){return this.vldId},getElem:function(){return this.el},getGroup:function(a){return this.groups[a]||
...
b){a[b]("statechange",this.onGroupStateChange,this)},initFields:function(){var a=this.el,b,c;if(this.isField)return this.add(a),this;a=D("input, textarea, select",a);b=-1;for(c=a.length;++b<c;this.add(a[b]));return this},initForm:function(a){var b=this.el,c=b.getElementsByTagName("input"),d=D(".submit",b),e=D(".reset",b);a="bind"==a?O:P;var f,g,k,l;f=0;for(g=c.length;f<g;f++)l=c[f],k=l.type,"submit"==k?a(l,"click",this.onRealSubmitClickDelegate):"reset"==k&&a(l,"click",this.resetDelegate);f=-1;for(g=
...
delete a[c]);for(c in b)b.hasOwnProperty(c)&&b[c]&&(this.setFieldEvents(b[c],"un"),b[c].destroy(),delete b[c]);this._observable.destroy();delete this._observable;this.initForm("unbind");delete this.fields;delete this.groups;delete this.el;delete this.cfg}};n.defaults={};n.messages={};n.fieldDefaults={};n.groupDefaults={};n.addMethod=function(a,b,c){m[a]||(m[a]=b,c&&(n.messages[a]=c))};n.getValidator=function(a){a=a.getAttribute("data-validator");return e[a]||null};return n}();window.jQuery&&(jQuery.fn.metaphorjsValidator=
function(d,e,g){var f="metaphorjsValidator",k;"string"==typeof d&&"destroy"!=d&&(k=d,d=e,e=g);e=e||"default";d=d||{};f+="-"+e;this.each(function(){var g=$(this),q=g.data(f);if("destroy"==d)q&&(q.destroy(),g.data(f,null));else{if(q)throw Error("MetaphorJs validator is already instantiated for this html element");d.form=g;d.instanceName=e;g.data(f,new K(k,d))}})});return K});
